...
Route::prefix('receptionist')->name('receptionist.')->middleware('auth')->group(function () {
    Route::get('dashboard', function () {
    ...
    Route::get('/receptionist/appointments', [ReceptionistController::class, 'manageAppointments'])
        ->name('appointments');

    Route::post('/receptionist/appointments/store', [ReceptionistController::class, 'storeAppointment'])
