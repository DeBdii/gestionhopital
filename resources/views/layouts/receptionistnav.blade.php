<nav x-data="{ open: false }" class="bg-green-600 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 text-white shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('receptionist.dashboard')" :active="request()->routeIs('dashboard')" class="text-white">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('receptionist.patients')" :active="request()->routeIs('patients')" class="text-white">
                        {{ __('Gestion des patients') }}
                    </x-nav-link>
                </div>
                <!-- Add this new link -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('receptionist.appointments')" :active="request()->routeIs('receptionist.appointments')" class="text-white">
                        {{ __('Prise de rendez-vous') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('receptionist.stock')" :active="request()->routeIs('receptionist.stock')" class="text-white">
                        {{ __('Gestion de stock') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('receptionist.dashboard')" :active="request()->routeIs('dashboard')">
                {{ __('Dashboard') }}
