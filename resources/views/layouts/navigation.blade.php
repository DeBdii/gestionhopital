        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('dashboard')" class="text-white">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.doctors.index')" :active="request()->routeIs('doctor-management')" class="text-white">
                        {{ __('Gestion des docteurs') }}
                    </x-nav-link>
                </div>
                <!-- Add this new link -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.staff.index')" :active="request()->routeIs('staff-management')" class="text-white">
                        {{ __('Gestion de staff') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.departments.index')" :active="request()->routeIs('department-management')" class="text-white">
                        {{ __('Gestion des départements') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.shifts.index')" :active="request()->routeIs('shifts-management')" class="text-white">
                        {{ __('Gestion des shifts') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.items.index')" :active="request()->routeIs('stock-management')" class="text-white">
                        {{ __('Gestion de stock') }}
                    </x-nav-link>
                </div>
            </div>
