...
<div class="container">
    ...
    <div class="card mb-4">
        ...
        <div class="card-footer">
            <a href="{{ route('receptionist.patients') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to List</a>
        </div>
    </div>
                    ...
                    <div class="card medical-record-card" id="medicalRecordCard{{ $record->id }}">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="edit-buttons">
                                ...
                                <form action="{{ route('receptionist.medicalrecords.destroy', $record->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this medical record?');">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="card-body">
                            <form id="medicalRecordForm{{ $record->id }}" method="POST" action="{{ route('receptionist.medicalrecords.update', $record->id) }}" class="medical-record-form">
                                @csrf
                                @method('PUT')
...
<div class="modal fade" id="addMedicalRecordModal" tabindex="-1" role="dialog" aria-labelledby="addMedicalRecordModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="addMedicalRecordForm" method="POST" action="{{ route('receptionist.medicalrecords.store') }}">
                @csrf
