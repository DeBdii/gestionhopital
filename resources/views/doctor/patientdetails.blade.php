                ...
                @else
                    @foreach ($patient->medicalRecords as $index => $record)
                        <div class="card medical-record-card" id="medicalRecordCard{{ $record->id }}">
                            <div class="card-header bg-gray-700 text-white flex justify-between items-center">
                                ...
                                <div class="edit-buttons">
                                    ...
                                    <form action="{{ route('doctor.medicalrecords.destroy', $record->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
...
<script>
    $(document).ready(function() {
        ...
        $('.edit-button').click(function() {
            ...
            $('#medicalRecordForm' + recordId + ' input, #medicalRecordForm' + recordId + ' textarea').prop('readonly', false);
            $(this).hide();
            $('#medicalRecordCard' + recordId + ' .save-button').show();
        });
